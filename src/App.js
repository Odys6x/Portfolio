...
function App(){
    return(
        ...
        <div class="hero-container" data-aos="fade-in">
          ...
          <p>I'm <span class="typed" data-typed-items="A Developer, A Gamer"></span></p>
        </div>
      </section>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Bachelor (Currently pursuing)</span></li>
